...
class TestLaceScene0(Scene):
    def construct(self):
        ...
        lace = Lace(star, offset=0.1, stroke_color=BLACK, stroke_width=1, fill_color=WHITE, fill_opacity=0.5)
        self.add(lace)
...
class TestLaceScene2(Scene):
    def construct(self):
        ...
        lace = Lace(grid, offset=0.1, stroke_color=BLACK, stroke_width=1, fill_color=WHITE, fill_opacity=0.5)
        self.add(lace)
